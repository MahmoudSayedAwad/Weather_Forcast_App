...
class FavouriteAdapter(var context: Context?, var fav: FavouriteInterface) :
    ListAdapter<FavouriteCityEntity, FavouriteViewHolder>(FavouriteDiffUtil()) {
    ...
    override fun onBindViewHolder(holder: FavouriteViewHolder, position: Int) {
        ...
        holder.binding.deleteThisRow.setOnClickListener { fav.delete(current, position) }
